      ...
      <div className="bannerServices">
        ...
        <div className="service-container">
          <div className="service-item" data-wow-delay="0.1s">
            ...
            <Link className="linkcolor" href="https://earningappsolutions.online" target="blank">View</Link>
          </div>
          <div className="service-item" data-wow-delay="0.3s">
            ...
            <Link className="linkcolor" href="https://bajpaiinstitutions.com" target="blank">View</Link>
          </div>
          <div className="service-item" data-wow-delay="0.5s">
            ...
            <Link className="linkcolor" href="https://aberpsolutions.com" target="blank">View</Link>
          </div>
        </div>
      </div>
